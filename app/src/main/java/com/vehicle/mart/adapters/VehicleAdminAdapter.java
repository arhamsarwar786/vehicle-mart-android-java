...
import com.vehicle.mart.VehicleAdminDetailsActivity;
import com.vehicle.mart.VehicleDetailsActivity;
import com.vehicle.mart.home.AdminActivity;

import java.util.List;

public class VehicleAdminAdapter extends RecyclerView.Adapter<VehicleAdminAdapter.ViewHolder> {
    Context context;
    List<Vehicle> vehicleList;

    public VehicleAdminAdapter(Context context, List<Vehicle> vehicleList) {
    ...
    @NonNull
    @Override
    public VehicleAdminAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_home,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull VehicleAdminAdapter.ViewHolder holder, int position) {
        ...
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, VehicleAdminDetailsActivity.class);
